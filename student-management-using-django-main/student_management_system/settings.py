...
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER') or os.environ.get('EMAIL_ADDRESS', '')
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER or 'noreply@student-management.local')

# OTP SMS (Twilio) configuration
