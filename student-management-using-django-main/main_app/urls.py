...
urlpatterns = [
    path("", views.login_page, name='login_page'),
     path("chatbot/message/", views.website_chatbot, name='website_chatbot'),
     path("verify-totp/", views.verify_totp, name='verify_totp'),
     path("verify_totp/", views.verify_totp),
     path("setup-totp/", views.setup_totp, name='setup_totp'),
     path("setup_totp/", views.setup_totp),
     path("disable-totp/", views.disable_totp, name='disable_totp'),
     path("disable_totp/", views.disable_totp),
    ...
    path("staff/attendance/face/", staff_views.staff_take_attendance_face,
         name='staff_take_attendance_face'),
    path("staff/face/register/", staff_views.register_student_face,
         name='register_student_face'),
    path("staff/face/recognize/", staff_views.recognize_face_and_mark_attendance,
         name='recognize_face_and_mark_attendance'),
    path("staff/face/get_students/", staff_views.get_students_for_face_registration,
         name='get_students_for_face_registration'),
